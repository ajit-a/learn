 ...
 *   */ 
#define USERNAME "ajit@tethys.vegayan"
#define PASSWORD "ajit"
#define SMTPSERVER "tethys.vegayan"
#define SMTPPORT ":25" 
#define RECIPIENT "chaitanya@tethys.vegayan>"
#define MAILFROM "<anonymous@vegayan.com>"
